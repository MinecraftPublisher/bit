...
|`01`MOV`<from:addr>`<to:addr>````````````````````````````````Moves`data`between`regsiters,`Memory`addresses`and`constants.````````````````|\n
|`10`JUMP`<on:`zero/less/more>`<to:adrr>``````````````````````Jumps`on`said`conditions`(or`gate)`to`said`address.``````````````````````````|\n
|`11`MATH`<op:`+/N>`<left:addr>`<right:addr>`<dest:addr>``````Performs`math`on`two`numbers`and`puts`the`result`in`the`destination.`````````|\n
|``````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````|\n
|`ENCODING:````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````|\n
